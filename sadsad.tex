...
%{\parbox[c][25pt][c]{\textwidth}{\hspace{15pt}\textcolor{white}{Experience}}} %%Contacts separator
   \LARGE
             ...
             \large
             \vspace*{10pt}
             \ExperienceEntry{2012{2016{f f ofid foid fo dfodsifo dpofd{fsdsdb grgrrr45 b46454ffggtryt rgrgwrg wrerwrwe{}\break\ExperienceEntry{2016{2020{ewr reerewrewr er{ewrerwer werwer vfgvregrgr grrgrgrg{}\break
            \vspace*{5pt}
%%Contact Information
%\large
%\vspace*{10pt}
...
\textBox{
 trt t4t44dgy5y56u6htrhtr regert
}\\
