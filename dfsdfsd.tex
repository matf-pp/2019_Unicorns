...
\firstname{dfsdfsd} % Your first name
\familyname{fd} % Your last name
...
\begin{multicols}{2}
  ...
  \cvitem{Name}{dfsdfsd fd}
  \cvitem{Date of Birth}{\emph{sfsd}}
  \cvitem{Address}{f}
  \cvitem{Mobile}{sdfsdfdsf}
  \cvitem{Email}{f}
  \columnbreak
  \includegraphics[width=28mm, right]{/home/unicorns/Desktop/Unicorns slike/Jednorozi/81j5RZdJ+2L._SL1400_.jpg}
\end{multicols}
...
%----------------------------------------------------------------------------------------
\section{Education}
            \cvitem{ff -- fdsd}{\textbf{fdsff } \textit{}
                  \newline dsfdf}
...
\subsection{Technical skills}
            \cvitem{}{fsdfsdf, \textit{dsfdsfdsf}}
