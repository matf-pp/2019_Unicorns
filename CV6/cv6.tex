...
\begin{center}
	\vspace{14pt}
	\textcolor{light}{\small{Profesn $\cdot$  AdreSSa $\cdot$  mejl  $\cdot$ telefon}}\\
	\HUGE{\textcolor{white}{\textsc{ImePrezime}} } \textcolor{sectcol}{\rule[-1mm]{1mm}{0.9cm}} \HUGE{\textcolor{white}{\textsc{Resume}} }
\end{center}
\end{minipage}}\\[-4pt]
%----------------------------------------------------------------------------------------
% SUMMARY
...
\begin{center}
\parbox[c]{\innerwidth}{
	\includegraphics[height = 4cm, widht = 4cm]{"pokusajSlike"}
	\hspace{8pt}
	\parbox[b]{5cm}{
