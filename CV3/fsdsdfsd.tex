...
\address{fsdfsdsdf}{}{df}% optional, remove / comment the line if not wanted; the "postcode city" and and "country" arguments can be omitted or provided empty
\phone[mobile]{sd}                   % optional, remove / comment the line if not wanted
\email{fsd}                               % optional, remove / comment the line if not wanted
